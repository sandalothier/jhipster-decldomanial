...
import com.fisc.decldomanial.DecldomanialApp;
...
@SpringBootTest(classes = DecldomanialApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecldomanialKafkaResourceIT {
    ...
    @Autowired
    private DecldomanialKafkaProducer producer;

    @Autowired
    private DecldomanialKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecldomanialKafkaResource kafkaResource = new DecldomanialKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decldomanial-kafka/publish?message=test"))
